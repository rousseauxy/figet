...
4. **OpenID Connect.** Done 2026-09-13, verified against a real Authentik provider: providers page, runtime schemes,
   sign-in page modes and the local fallback, account creation, connect and disconnect on the profile page, group
   mapping. Entra ID followed on 2026-09-15.
