...
namespace FiGet.Infrastructure.SqlServer;
...
/// <summary>Used by <c>dotnet ef migrations add --project src/FiGet.Infrastructure.SqlServer</c>. Never connects.</summary>
